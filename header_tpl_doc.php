<?php // header.php
	...
	<html lang="ru">
		<head>
			...
			<script src="/re/js/calender.js"></script>
			<script src="/re/js/myFunctions.js"></script>
			...
			<link rel="stylesheet" href="/re/css/jquery.minical.plain.css" type="text/css">
			<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css" />
			<link rel="stylesheet" href="/re/css/w3.css">
			<!--[if lt IE 9]> 
			<script type="text/javascript" src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script>
			<![endif]-->
			<script type="text/javascript" src="/re/js/jquery-3.1.1.js"></script>
...
<nav class="w3-sidebar w3-grey w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-container">
    <h3 class="w3-padding-64"><b>MEDICAL<br>invoicing</b></h3>
  </div>
